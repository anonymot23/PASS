...
from src.optimal_execution.PASS.pass_ import PassAgent
...
class VGeneratorPass(object):
    ...
    def __init__(self, s_0, x_0, q_0, nb_iter= 100, nb_episode = 100, 
                 ...
                 kappa = 0.1, phi = 1, A = 0.25, gamma = 0.1,
        ...
        self.passAgent = PassAgent(self.s_0, self.x_0, self.q_0,
                                    self.nb_iter, self.time_step, 
                                    self.size_q, self.q_max, self.mu,
                                    self.alpha, self.alpha_min, 
                                    self.alpha_max, self.r,
                                    self.var, self.kappa,
                                    self.phi)
